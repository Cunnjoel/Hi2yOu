...
class ProfileServiceTest
{
    ...
    void createProfile()
    {
        ...
        Profile profileToPass = new Profile(1,newUser,"Kevin",null,"Childs","7/05/1985","Houston","Texas",null);
    ...
    void getProfile()
    {
        Integer profileId = 1;
        User newUser = new User();
        Profile expectedProfile = new Profile(1,newUser,"Kevin",null,"Childs","7/05/1985","Houston","Texas",null);
    ...
    {
        User newUser = new User();
        Profile updatedProfile = new Profile(1,newUser,"Kevin","M","Childs","7/05/1985","Houston","Texas"," Hi my name is Kevin and I'll be your instructor.");
